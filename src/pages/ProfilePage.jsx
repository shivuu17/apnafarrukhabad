          ...
          <motion.section initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }} className="mt-6 rounded-2xl border border-slate-200 bg-white shadow-soft">
            ...
            <div className="grid gap-3 p-4 sm:grid-cols-2 sm:p-6">
              ...
              <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 sm:col-span-2">
                ...
                {(!phoneVerified || !emailVerified) && <p className="mt-3 inline-flex items-center gap-2 text-xs font-semibold text-amber-700"><ShieldAlert size={14} /> Complete pending verification to increase trust and reach.</p>}
              </div>
            </div>
          </motion.section>
